...
export class TodoController {
    ...
    async create(@Body() params: TodoParams): Promise<TodoVm> {
        try {
            ...
            return this._todoService.map(newTodo, TodoVm);
        } catch (e) {
    ...
    async get(
        ...
        try {
            ...
            return this._todoService.mapArray(todos, TodoVm);
        } catch (e) {
            throw new HttpException(e, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    async update(@Body() vm: TodoVm): Promise<TodoVm> {
        ...
        try {
            ...
            return this._todoService.map(updated, TodoVm);
        } catch (e) {
            throw new HttpException(e, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    async delete(@Param('id') id: string): Promise<TodoVm> {
        try {
            ...
            return this._todoService.map(deleted, TodoVm);
        } catch (e) {
